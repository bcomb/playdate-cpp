...
void test(float t)
{
    ...
    if (pd->system->isCrankDocked())
    {
        ...
        {         
            targetAngle = currentAngle - maxAngleSpeed * dt;
        }
    ...
    if (sContacts.size())
    {
        ...
        if (bestContact)
        {
            ...
            */
            ...
            ship.pos = bestContact->newPos + bestContact->n * 0.375f; // Push it a bit farther to avoid constant contact
            ...
            SfxHissGraze(RandomFloat01(&RNG));
